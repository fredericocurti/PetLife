...
function appendpets(x){
	if (x > 0){
		for (i=0; i < indexes.length; i++) {
			...
			document.getElementById("petimg").innerHTML = '<img src="' + indexes[i]["Foto"] +'" width="inherit" class="thumbpet">';
			document.getElementById("petname").innerHTML = indexes[i]["Nome do Pet"];
			document.getElementById("clientname").innerHTML = indexes[i]["Nome do Cliente"];
...
function showinfo(){
	document.getElementById("showimg").setAttribute("src",indexes[localStorage.escolha]["Foto"]);
}
